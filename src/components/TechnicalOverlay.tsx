  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        >
          {/* Hero Header */}
          <div className="mb-2 sm:mb-3 md:mb-6 animate-in">
          ...
          {/* Stats Row */}
          <div className="flex gap-2 sm:gap-4 md:gap-10 mb-2 sm:mb-3 md:mb-6 animate-in pb-2 sm:pb-3 md:pb-6 border-b border-neutral-200">
            <div>
